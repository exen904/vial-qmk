...
[0] = LAYOUT_all(
    ...
    KC_ESC ,KC_Q   ,KC_W   ,KC_E   ,KC_R   ,KC_T   ,KC_Y   ,KC_U   ,KC_I   ,KC_O   ,KC_P   ,KC_LBRC              , KC_P7  ,KC_P8  ,KC_P9  ,KC_PMNS,
...
[1] = LAYOUT_all(
    QK_BOOT  ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_RBRC            , KC_HOME,XXXXXXX,KC_PGUP,XXXXXXX,
...
[2] = LAYOUT_all(
    KC_GRV ,KC_1   ,KC_2   ,KC_3   ,KC_4   ,KC_5   ,KC_6   ,KC_7   ,KC_8   ,KC_9   ,KC_0   ,KC_MINS              , XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
...
[3] = LAYOUT_all(
    KC_TILD,KC_EXLM,KC_AT  ,KC_HASH,KC_DLR ,KC_PERC,KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_UNDS              , KC_NUM ,KC_PSLS,KC_PAST,XXXXXXX,
